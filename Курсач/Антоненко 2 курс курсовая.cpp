...
#define DEFAULT_LIBRARY "library.db"
#define DEFAULT_CLIENTS "clients.db"
#define FIELD_LEN 20

char cin_buf[FIELD_LEN+1];
...
class LibraryItem {
    ...
    public:
        ...
        LibraryItem(void){
            cout << "id: "; cin.getline(cin_buf, FIELD_LEN); id = cin_buf;
            cout << "name: "; cin.getline(cin_buf, FIELD_LEN); name = cin_buf;
            cout << "year: "; cin.getline(cin_buf, FIELD_LEN); year = cin_buf;
            cout << "city: "; cin.getline(cin_buf, FIELD_LEN); city = cin_buf;
            cout << "sum: "; cin.getline(cin_buf, FIELD_LEN); sum = cin_buf;}
...
class Magazine : public LibraryItem {
    ...
    public:
        ...
        Magazine(): LibraryItem(){
            item_type = "magazine";
            cout << "number: "; cin.getline(cin_buf, FIELD_LEN); number = cin_buf;
            cout << "publisher: "; cin.getline(cin_buf, FIELD_LEN); publisher = cin_buf;
            cout << "topic: "; cin.getline(cin_buf, FIELD_LEN); topic = cin_buf;}
...
class Book : public LibraryItem{
    ...
    public:
        ...
        Book() : LibraryItem(){
            item_type = "book";
            cout << "author: "; cin.getline(cin_buf, FIELD_LEN); author = cin_buf;
            cout << "genre: "; cin.getline(cin_buf, FIELD_LEN); genre = cin_buf;
            cout << "cover: "; cin.getline(cin_buf, FIELD_LEN); cover = cin_buf;}
...
class Client{
    ...
    public:
        ...
        Client(){
            cout << "id: "; cin.getline(cin_buf, FIELD_LEN); id = cin_buf;
            cout << "name: "; cin.getline(cin_buf, FIELD_LEN); name = cin_buf;
            cout << "phone: "; cin.getline(cin_buf, FIELD_LEN); phone = cin_buf;}
...
/*===========================================================================*/
        ...
        void add_item(void){
            ...
            string line;
            while(1){
                cout << "input item_type, please: ";
                cin.getline(cin_buf, FIELD_LEN); line = cin_buf;
...
/*===========================================================================*/
        ...
        void lend_item(void){
            ...
            cout << "Account id: "; cin.getline(cin_buf, FIELD_LEN); account_id = cin_buf;
            cout << "Item id: "; cin.getline(cin_buf, FIELD_LEN); item_id = cin_buf;
            for(int i=0; i<clients_size; i++){
...
void interaction_menu(Library* lib){
    ...
    while(1){
        ...
        cout << "3 to get back\n";
        while(1){
            cout << ">>> "; cin.getline(cin_buf, FIELD_LEN); choise = cin_buf;
            if(choise == "1"){
                lib->lend_item();
                break;}
            else if(choise == "2"){
